...
class TabelloneTurniVolontario(val cognomeNomeSpinner: String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        segnami_cancellami_btn.setOnClickListener {
            ...
            //TODO (esiste un imperfezzione per cui le ore delle statistiche vengono calcolate in base alle prenotazioni appena effettuate e non al tunro appena eseguito, questo è dovuto alla mancanza delle "cloud functions" nel piano base )
        }
